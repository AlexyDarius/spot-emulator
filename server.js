...
// Import the CONFIG from the main emulator
const CONFIG = {
...
app.get('/api/spot-emulator', (req, res) => {
  ...
  console.log(`📡 Served ${serverState.messages.length} messages to ${req.ip}`);
});

app.get('/api/spot-emulator/status', (req, res) => {
...
app.get('/api/spot-emulator-client.js', (req, res) => {
...
app.post('/api/spot-emulator/sync', (req, res) => {
...
app.post('/api/spot-emulator/control', (req, res) => {
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 SPOT Emulator running on http://localhost:${PORT}`);
  console.log(`📡 API endpoints:`);
  console.log(`   - Web Interface: http://localhost:${PORT}/`);
  console.log(`   - XML Feed: http://localhost:${PORT}/api/spot-emulator`);
  console.log(`   - Status: http://localhost:${PORT}/api/spot-emulator/status`);
  console.log(`   - Client Script: http://localhost:${PORT}/api/spot-emulator-client.js`);
